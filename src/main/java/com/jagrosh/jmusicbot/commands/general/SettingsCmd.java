...
public class SettingsCmd extends Command 
{
	...
	protected void execute(CommandEvent event) 
	{
		...
		EmbedBuilder ebuilder = new EmbedBuilder()
				...
				.setDescription("Text Channel: " + (tchan == null ? "Any" : tchan.getAsMention())
				...
				.setFooter(event.getJDA().getGuilds().size() + " servers | " + connections + " audio connection" + (connections==1 ? "" : "s"), null);
